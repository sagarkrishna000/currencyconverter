  ...
  return (
    <div className={`bg-white p-3 rounded-lg text-sm flex ${className}`}>
      ...
      <div className="w-1-2 flex flex-wrap justify-end text-right">
        ...
        <select className='rounded-lg px-1 py-1 y-100 cursor-pointer outline-none' value={defaultCurrency} onChange={(e) =>{onCurrencyChange && onCurrencyChange(e.target.value)}} disabled={currencyDisabled}>
